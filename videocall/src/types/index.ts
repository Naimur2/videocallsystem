export interface Participant {
  ...
  avatar?: string;
  joinedAt: Date;
  videoStream?: globalThis.MediaStream;
  audioStream?: globalThis.MediaStream;
  screenStream?: globalThis.MediaStream;
}
...
export interface ClientToServerEvents {
  ...
  // MediaSoup events - following reference pattern
  getRtpCapabilities: (
    callback: (response: {
